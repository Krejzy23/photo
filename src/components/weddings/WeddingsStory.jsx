...
const WeddingsStory = () => {
  return (
    <div className="h-[30vh] bg-violet-50 w-screen">
      <div className="relative mb-8 flex flex-col items-center justify-center gap-5">
        <p className="font-general mt-5 text-xs uppercase md:text-[10px]">
        "Emotive storytelling of your most important day."
        </p>
        <h1 className="md:px-20 px-10 wedding-hero-heading z-40">
